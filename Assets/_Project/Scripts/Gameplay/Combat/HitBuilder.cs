...
namespace Momotaro.Gameplay.Combat
{
    ...
    ///
    /// 責務は「ガード可否・ジャストガード可否といった防御フラグの写し取り」と「命中情報の梱包」まで。
    ...
    {
        /// <summary>
        /// <see cref="AttackData"/> の防御フラグを反映しつつ命中情報を生成する。
        /// </summary>
        /// <param name="data">攻撃データ原本（読み取りのみ）。</param>
        ...
        public static HitInfo FromAttack(
            ...
            HitId hitId)
        {
            bool guardable = data != null && data.Guardable;
            bool justGuardable = data != null && data.JustGuardable;
